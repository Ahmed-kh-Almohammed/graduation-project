...
export interface ApiAllargyAllargy extends Schema.CollectionType {
  collectionName: 'allargies';
  info: {
    singularName: 'allargy';
    pluralName: 'allargies';
    displayName: '\u0627\u0644\u062D\u0633\u0627\u0633\u064A\u0627\u062A';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paragraph: Attribute.Component<'bloging-tool.paragraph', true>;
    relatedblogs: Attribute.Relation<
      'api::blog.blog',
      'oneToMany',
      'api::blog.blog'
    >;
    blogSlug: Attribute.UID & Attribute.Required;
    SEO: Attribute.Component<'otherr.seo'>;
    tags: Attribute.JSON & Attribute.CustomField<'plugin::tagsinput.tags'>;
    authors: Attribute.Component<'otherr.theauthor'>;
    media: Attribute.Component<'social.media'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiContactFormContactForm extends Schema.CollectionType {
  ...
  info: {
    ...
    displayName: '\u0645\u0639\u0644\u0648\u0645\u0627\u062A \u0646\u0645\u0648\u0630\u062C \u0627\u0644\u0627\u062A\u0635\u0627\u0644';
    description: '';
  };
  options: {
    draftAndPublish: false;
...
export interface ApiDoctorDoctor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    comuncation: Attribute.Component<'social.media'>;
...
export interface ApiPatientProfilePatientProfile extends Schema.CollectionType {
  ...
  attributes: {
    blodType: Attribute.Enumeration<['O', 'A', 'B', 'AB']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    nationality: Attribute.Enumeration<
      ['syrian', 'Arabian', 'chines', 'American']
    > &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    familyStatus: Attribute.Enumeration<
    ...
    lifeShort: Attribute.Blocks &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    IDFile: Attribute.Media<'images'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    diseases: Attribute.Relation<
      ...
      'api::disease.disease'
    >;
    sessions: Attribute.Component<'actions.session', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    prescription: Attribute.Component<'actions.prescription', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    Tests: Attribute.Component<'actions.medical-test', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    mainImage: Attribute.Media<'images', true> & Attribute.Required;
    Treatments: Attribute.Component<'list.treatment', true>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::allargy.allargy': ApiAllargyAllargy;
      'api::blog.blog': ApiBlogBlog;
      'api::contact-form.contact-form': ApiContactFormContactForm;
      'api::disease.disease': ApiDiseaseDisease;
      'api::doctor.doctor': ApiDoctorDoctor;
      'api::medicine.medicine': ApiMedicineMedicine;
      'api::patient-profile.patient-profile': ApiPatientProfilePatientProfile;
