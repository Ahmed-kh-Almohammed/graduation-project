...
const config = {
  ...
  translations: {
    en: {
        ...
        "Auth.form.button.login.Hermosa": "Log in via Hermosa",
        ...
        "Auth.form.register.subtitle": "Credentials are only used to authenticate in Hermosa. All saved data will be stored in your database.",
        "Auth.form.rememberMe.label": "Remember me",
        "Auth.form.username.label": "Username",
        "Auth.form.username.placeholder": "e.g. Kai_Doe",
        "Auth.form.welcome.subtitle": "Log in to your Hermosa account",
        "Auth.form.welcome.title": "Welcome to Hermosa!",
        ...
        "HomePage.welcome.congrats.content": "You are logged in as the first administrator. To discover the powerful features provided by Hermosa,",
        ...
        "Settings.application.ee.admin-seats.add-seats": "{isHostedOnHermosaCloud, select, true {Add seats} other {Contact sales}}",
        ...
        "Settings.application.Hermosa-version": "Hermosa version",
        "Settings.application.HermosaVersion": "Hermosa version",
        ...
        "Settings.permissions.users.listview.header.subtitle": "All the users who have access to the Hermosa admin panel",
        "Settings.permissions.users.roles": "Roles",
        "Settings.permissions.users.Hermosa-author": "Author",
        "Settings.permissions.users.Hermosa-editor": "Editor",
        "Settings.permissions.users.Hermosa-super-admin": "Super Admin",
        ...
        "admin.pages.MarketPlacePage.offline.subtitle": "You need to be connected to the Internet to access Hermosa Market.",
        ...
        "admin.pages.MarketPlacePage.plugin.tooltip.madeByHermosa": "Made by Hermosa",
        "admin.pages.MarketPlacePage.plugin.tooltip.verified": "Plugin verified by Hermosa",
        "admin.pages.MarketPlacePage.plugin.version": "Update your Hermosa version: \"{HermosaAppVersion}\" to: \"{versionRange}\"",
        "admin.pages.MarketPlacePage.plugin.version.null": "Unable to verify compatibility with your Hermosa version: \"{HermosaAppVersion}\"",
        ...
        "admin.pages.MarketPlacePage.subtitle": "Get more out of Hermosa",
        "admin.pages.MarketPlacePage.tab-group.label": "Plugins and Providers for Hermosa",
        ...
        "app.components.BlockLink.blog.content": "Read the latest news about Hermosa and the ecosystem.",
        "app.components.BlockLink.cloud": "Hermosa Cloud",
        ...
        "app.components.BlockLink.tutorial.content": "Follow step-by-step instructions to use and customize Hermosa.",
        ...
        "app.components.HomePage.welcomeBlock.content": "Congrats! You are logged as the first administrator. To discover the powerful features provided by Hermosa, we recommend you to create your first Content type!",
        "app.components.HomePage.welcomeBlock.content.again": "We hope you are making progress on your project! Feel free to read the latest news about Hermosa. We are giving our best to improve the product based on your feedback.",
        ...
        "app.components.LeftMenu.navbrand.title": "Hermosa Dashboard",
        ...
        "app.components.MarketplaceBanner": "Discover plugins built by the community, and many more awesome things to kickstart your project, on Hermosa Marketplace.",
        "app.components.MarketplaceBanner.image.alt": "A Hermosa rocket logo",
        ...
        "app.components.NpsSurvey.banner-title": "How likely are you to recommend Hermosa to a friend or colleague?",
        ...
        "components.AutoReloadBlocker.description": "Run Hermosa with one of the following commands:",
        ...
        "global.plugins.sentry.description": "Send Hermosa error events to Sentry.",
        ...
        "notification.ee.warning.over-.message": "Add seats to {licenseLimitStatus, select, OVER_LIMIT {invite} AT_LIMIT {re-enable}} Users. If you already did it but it's not reflected in Hermosa yet, make sure to restart your app.",
        ...
        "notification.version.update.message": "A new version of Hermosa is available!",
    ...
    ar: {
      'app.components.LeftMenu.navbrand.title': 'advaced urgent care',
      'app.components.LeftMenu.navbrand.workplace': 'admine',
      "Auth.form.welcome.title": "welcome to advaced urgent care",
        "Auth.form.welcome.subtitle": "Log in to advaced urgent care",
        "Auth.form.button.login.strapi": "Log into advaced urgent care",
